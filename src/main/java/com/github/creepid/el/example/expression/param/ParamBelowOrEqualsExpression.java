 ...
 */
public class ParamBelowOrEqualsExpression extends ParamComparableExpression<Double,Double> {

    public ParamBelowOrEqualsExpression(EvaluationContext context) {
        super(context);
    }
